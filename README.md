...
Пока что, скажем так, вполне рабочая бета-версия. Не все тесты доделаны.

### Изменения изначального кода
...
* Не всегда корректно срабатывает изменение стиля курсора во время хода противника.
